...
export default function ThankYouWorkshop() {
  const { t } = useTranslation("thankYouWorkshop");
  const { t: tSeries } = useTranslation("workshopSeries");
  const { to } = useLocale();
  ...
  return (
    <div className="bg-brand-cream text-slate-800">
      <Seo pageKey="thankYouWorkshop" path="/thank-you-workshop" image="/page-hero/workshop-hero.webp" noindex />
            ...
            <div className="mt-8 grid grid-cols-1 gap-6 border-t border-slate-100 pt-8 sm:grid-cols-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="leading-tight">
                  ...
                  {/* Not a link on purpose — the Zoom URL is only ever exposed
                      through the calendar exports below, never as a clickable
      ...
      {/* ===================== RESOURCES ===================== */}
      <section className="mx-auto max-w-3xl px-4 pb-16 sm:px-6 md:pb-20 lg:px-8">
        <motion.div
